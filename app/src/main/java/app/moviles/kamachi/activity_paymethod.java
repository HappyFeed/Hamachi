...
public class activity_paymethod extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        synapButton=findViewById(R.id.pagarBtn);
        ...
        Button startPayment=findViewById(R.id.nextBtn);
    ...
    private void startPayment(){
        ...
        SynapPayButton.setListener(new EventHandler() {
            ...
            public void onEvent(SynapPayButton.Events event) {
                ...
                switch (event){
                    case START_PAY:
                        paymentButton=findViewById(R.id.pagarBtn);
